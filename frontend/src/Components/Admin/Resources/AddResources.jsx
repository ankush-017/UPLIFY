    ...
    return (
        <>
            <Seo
                ...
                description="Upload and share new educational resources for students."
                url="https://uplify.in/admin/resources/add"
                image="https://uplify.in/og-image-resources.jpg"
            />
