...
function AIML() {
  ...
  const prompt = `
Give me a step-by-step tech-stack-name roadmap to become a AI/ML Engineer. Return it strictly as a pure JSON array of objects. 
    ...
    <div className={`min-h-screen px-4 py-12 transition-all duration-300 ${darkMode ? "bg-black" : "bg-gradient-to-br from-white via-blue-50 to-blue-100"}`}>
      <div className="max-w-7xl mx-auto">
        <h1 className={`text-4xl md:text-5xl font-extrabold text-center mb-4 ${darkMode ? "text-blue-500" : "text-blue-700"}`}>
          <span className={`${darkMode ? "text-pink-500" : "text-pink-600"}`}>AI / ML Engineer</span> Roadmap
        </h1>
        <p className={`text-center mb-12 text-lg max-w-3xl mx-auto ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
            A carefully crafted step-by-step journey to becoming a proficient AI/ML Engineer. Explore core concepts of machine learning, deep learning, and data science, master essential tools like Python, TensorFlow, and scikit-learn, and access top resources to build intelligent, real-world AI solutions.
        </p>

        {loading ? (
          <div className="flex flex-col items-center justify-center min-h-[200px]">
            <p className="text-lg text-gray-500 text-center mb-4">Preparing Roadmap for AL/ML Engineer...</p>
            <Spin size="large" />
          </div>
        ) : error ? (
