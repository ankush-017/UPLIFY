...
function Footer() {
  return (
    <footer className="bg-gradient-to-tr from-gray-800 via-gray-900 to-blue-950 text-gray-300 border-t-2 pt-10 pb-6 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
        ...
        {/* Navigation */}
        <div>
          <h4 className="text-blue-400 text-lg font-semibold mb-3">Explore</h4>
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/blog" className="hover:text-blue-400">Blogs</Link></li>
          </ul>
        </div>

        {/* Tools */}
        <div>
          <h4 className="text-blue-400 text-lg font-semibold mb-3">Tools</h4>
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/user/uplify-community" className="hover:text-blue-400">Uplify-Community</Link></li>
          </ul>
        </div>
