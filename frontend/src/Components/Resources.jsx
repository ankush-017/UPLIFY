...
import { ArrowBigRightDash, ExternalLink, IndianRupee, Search } from 'lucide-react';
    ...
    <>
      <div className={` ${darkMode ? "bg-black" : "bg-white"} grid grid-cols-1 lg:grid-cols-4 gap-6`}>
        ...
        <div className={`lg:col-span-3 min-h-screen py-10 px-4 sm:pr-14 pb-14 text-white rounded-xl`}>
          {/* <h2
            className={`text-center text-md font-semibold mb-2 ${darkMode ? "text-gray-200" : "text-purple-600"
              }`}
          >
            Get Resources from AI Search
          </h2> */}
          <div className="flex justify-center items-center mb-6">
            ...
            >
              ...
              />
              <Search className="text-blue-500 cursor-pointer" onClick={handleSearch} />
            </div>
          </div>
