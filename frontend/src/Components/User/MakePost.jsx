...
function MakePost() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-6 transition-colors duration-700 ${darkMode ? 'bg-[#020617]' : 'bg-slate-50'
      }`}>
      {/* Background Glows */}
      ...
      >
        ...
        <div className="flex items-center justify-between mt-8">
          <label className={`flex items-center gap-2 cursor-pointer px-5 py-3 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all ${darkMode ? 'bg-white/5 text-emerald-400 hover:bg-emerald-500/10' : 'bg-slate-100 text-slate-600 hover:bg-emerald-50 hover:text-emerald-600'
            }`}>
            <ImagePlus size={18} />
